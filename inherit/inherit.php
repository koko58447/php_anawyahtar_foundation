...
<div id="content-wrapper">
    <div class="container-fluid">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">အမွေခံအလှူ</li>
        </ol>
        ...
        <div class="card mb-3">
            <div class="card-header bg-primary text-white">
                ...
                <form method="POST" action="inherit_action.php" class="float-right">
            ...
            <form id="frmsave">
                <div class="modal-body row">
                    <div class="col-md-6 form-group">
                        ...
                        <select class="form-control text-primary" name="dname" required>
                            <option value=""><sub>Please select Donater Name</sub></option>
                            <?php echo load_donater() ?>
                        </select>
                    </div>
                    <div class="col-md-6 form-group">
                        <label for="">ရှင်သာမဏေ</label>
                        <select class="form-control text-primary" name="sname" required>
                            <option value=""><sub>Please select Student Name</sub></option>
                            <?php echo load_student() ?>
                        </select>
                    </div>
                    <div class=" col-md-6 form-group">
                        <label for="">ဆရာ</label>
                        <select class="form-control text-primary" name="tname" required>
                            <option value=""><sub>Please select Teacher Name</sub></option>
...
$(document).ready(function() {
    ...
    function load_pag(page) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo roothtml.'inherit/inherit_action.php' ?>",
            data: {
                action: 'show',
                page_no: page,
