...
<div id="content-wrapper">
    <div class="container-fluid">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">အထူးအလှူရှင်</li>
        </ol>
        ...
        <div class="card mb-3">
            <div class="card-header bg-primary text-white">
                ...
                <form method="POST" action="special_donation_action.php" class="float-right">
...
$(document).ready(function() {
    ...
    function load_pag(page) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo roothtml.'donation/special_donation_action.php' ?>",
            data: {
                action: 'show',
                page_no: page,
