...
<div id="content-wrapper">
    <div class="container-fluid">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">သာသနာပြုမိသားစုအလှူ</li>
        </ol>
        ...
        <div class="card mb-3">
            <div class="card-header bg-primary text-white">
                ...
                <form method="POST" action="family_donation_action.php" class="float-right">
        ...
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="exampleModalLabel">
                    <i class="fa fa-plus"></i>
                    သာသနာပြုမိသားစုအလှူ အသစ်သွင်းရန်
                </h5>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="exampleModalLabel">
                    <i class="fa fa-plus"></i>
                    သာသနာပြုမိသားစုအလှူ ပြင်ဆင်ရန်
                </h5>
                <button class="close text-white" type="button" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
...
$(document).ready(function() {
    ...
    function load_pag(page) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo roothtml.'donation/family_donation_action.php' ?>",
            data: {
                action: 'show',
                page_no: page,
